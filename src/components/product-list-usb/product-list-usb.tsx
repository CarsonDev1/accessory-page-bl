...
async function fetchProductListDataTheNho() {
...
const Section5: React.FC = () => {
  ...
  const { data, error, isLoading } = useQuery<Product[]>({
    queryKey: ["productListDataTheNho"],
    queryFn: fetchProductListDataTheNho,
    staleTime: 300000,
  });

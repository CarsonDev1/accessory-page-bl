...
import "./product-list-samsung.scss";
...
async function fetchProductListDataSamsung() {
...
const Section5: React.FC = () => {
  ...
  const { data, error, isLoading } = useQuery<Product[]>({
    queryKey: ["productListDataSamsung"],
    queryFn: fetchProductListDataSamsung,
    staleTime: 300000,
  });
  ...
  return (
    <div className="OldForNew-Section5" id="item-samsung">

...
import "./product-list-smart-home.scss";
...
async function fetchProductListDataSmartHome() {
...
const Section5: React.FC = () => {
  ...
  const { data, error, isLoading } = useQuery<Product[]>({
    queryKey: ["productListDataSmartHome"],
    queryFn: fetchProductListDataSmartHome,
    staleTime: 300000,
  });
  ...
  return (
    <div className="OldForNew-Section5" id="item-smart-home">

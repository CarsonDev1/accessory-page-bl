...
import DecorProductFire from '../../../../public/teacher/fire.gif';
import DecorProduct from '../../../../public/teacher/ic-to.png';
...
const AppleList: React.FC = () => {
	...
	const hotProducts = filteredData.slice(0, 2);
								...
								<div className='upgrade-hot-item'>
									...
									<div className='upgrade-hot-item-content'>
										<div className='upgrade-hot-item-header'>
											<Image
												src={DecorProductFire}
												width={120}
												height={120}
												quality={100}
												alt='decor-product'
												className='decor-product-fire'
											/>
											<span></span>

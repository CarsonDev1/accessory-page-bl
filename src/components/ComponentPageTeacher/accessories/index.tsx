...
import Access20k from '@/components/ComponentPageTeacher/accessories-halloween/acess-20k';
import Access110 from '@/components/ComponentPageTeacher/accessories-halloween/acess-110';
import Access210 from '@/components/ComponentPageTeacher/accessories-halloween/acess-210';
import Access310 from '@/components/ComponentPageTeacher/accessories-halloween/acess-310';
import AccessTo210 from '@/components/ComponentPageTeacher/accessories-halloween/acess-to210';
import Access290 from '@/components/ComponentPageTeacher/accessories-halloween/acess-290';
import './product.scss';
import 'swiper/css';
import Access10k from '@/components/ComponentPageTeacher/accessories-halloween/acess-10k';
...
const AccessoriesList: React.FC = () => {
	...
	return (
		<div className='product-list-teacher'>
								...
								<SwiperSlide key={tab.index} style={{ padding: '1.2rem 0' }}>
									<button
										...
										style={{
											...
											backgroundColor: activeTab === tab.index ? '#C47223' : '#fff',
											borderRadius: '8px',
											cursor: 'pointer',
